...
{   
	...
	JMenuItem m1_1,m1_2,m1_3,m1_4,m1_5,m2_1,m2_2,m2_5,m3_1,m3_2,m4_1,m5_1;
	JLabel l1,LogoColl;
	GridBagLayout gbl;
	...
	/*	m3_3 = new JMenuItem("Expiry Date Report",new ImageIcon("images//report.png"));
		m3.add(m3_3); */
		m4=new JMenu("About");
		mbar.add(m4);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			new AddNewSupplier(medicalID);
		}
		else if(ae.getSource()==m1_2)
		{
			new SearchSupplier(medicalID);
		}
		else if(ae.getSource()==m1_3)
		{
			new UpdateSupplier(medicalID);
		}
		...
		{
			new SearchMedicine(medicalID);
		}
		else if(ae.getSource()==m2_5)
		{
			new MedicineList(medicalID);
		}

		 else if(ae.getSource()==m3_1)
		 {
		   new DailyPurchaseReport(medicalID);
		 }

		  else if(ae.getSource()==m3_2)
		 {
		   new SupplierWiseMedList(medicalID);
		 }
