...
class Login extends JFrame implements ActionListener
{
	...
	Login()
	{
        ...
        l5 = new JLabel("Login");l5.setFont(new Font("Times New Roman",Font.BOLD,30));
		...
		t1.setToolTipText("Enter Medical ID");
		jf.add(t1);
		...
		b4 = new JButton("New Medical Registration");
		b4.setBounds(270,450,200,35);
		jf.add(b4);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				rs = stmt.executeQuery("select password from Medical where medid = "+ id);
				rs.next();
			...
			catch(Exception e1)
			{
			    ...
			    cnt++;
			    JOptionPane.showMessageDialog(null,"ID is wrong...","WARNING",JOptionPane.ERROR_MESSAGE);
			    t1.setText("");
			    p1.setText("");
			    if(cnt==3)
			    {
