...
public class DailyPurchaseReport extends JFrame implements ActionListener
{
    ...
    String strDate;
    public DailyPurchaseReport(int id)
    {
        medicalID = id;
       jf=new JFrame();
            ...
            {
	           {
                    ...
                    rs = stmt.executeQuery("SELECT sid,sname,mbno,mname,mexpdate,mquantity,mpurprice,msaleprice from medicine where mpurdate='"+strDate+"' and medid='" + medicalID+"'");
